# Requirements Archive: v1.0 AI Debugger MVP
...
- [x] **LIVE-02**: State diff viewer showing what changed in `tools_context['state']` between iterations
- [x] **LIVE-03**: Collapsible JSON tree renderer for messages, raw responses, and state data
...
*Last updated: 2026-02-20 — all 20 v1 requirements complete at milestone ship*
